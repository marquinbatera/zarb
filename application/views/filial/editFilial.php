...
<div class="row margin-top-10 margin-bottom-20">
      <div class="col-md-12">
            <h3 class="title">cadastro de Filiais</h3>
      </div>
  </div>
<form method="post" action="<?php echo base_url('filial/newFilial')?>" enctype="multipart/form-data">
  ...
  <div class="row margin-top-20">
  		<div class="col-md-12">
        	 <div class="form-group">
                ...
                <a href="<?php echo base_url('filial/listFilial') ?>" class="btn btn-default">Cancel</a>
            </div>
        </div>
  </div>
</form>
...
// BREADCRUMB //
$("#breadcrumb").append('<i class="icon icon-config"></i><strong><a href="<?php echo base_url('filial/listFilial');?>">Filial</a></strong><i class="glyphicon glyphicon-menu-right"></i> Cadastro');
