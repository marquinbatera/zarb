 ...
 */
$config['site_title']                 = "DeliveryMates";       // Site Title, example.com
//$config['admin_email']                = "site.motok@gmail.com"; // Admin Email, admin@example.com
$config['admin_email']                = "contacts@deliverymates.co.uk"; // Admin Email, admin@example.com
